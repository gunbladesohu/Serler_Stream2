...
# When(/^I click the "([^"]*)" button on the search result page$/) do |button1|
...
#   expect(page).to have_selector("div#save_result", visible: true)
# end
...
#   fill_in('search_result_description', :with => des)
# end
