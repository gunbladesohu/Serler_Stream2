...
@article9 = Article.create(title: 'EPISODE: An Extreme Programming Method for Innovative Software Based on Systems Design',
                           ...
                           research_questions: '', research_metrics: '',
                           type_id: @article_type5.id, status_id: @toBeAnalysed.id, is_active: false,
...
@article11 = Article.create(title: 'A novel approach towards sideslip velocity autopilot for an agile missile using hybrid PID control',
                            ...
                            research_questions: '', research_metrics: '',
                            type_id: @article_type3.id, status_id: @analystPickedUp.id, is_active: true,
                            peer_reviewed: true, relevance: true, not_duplicate: true, user_id: @user1.id)
...
ArticleUser.create(article_id: @article3.id, user_id: @user2.id)
ArticleUser.create(article_id: @article4.id, user_id: @user3.id)
ArticleUser.create(article_id: @article5.id, user_id: @user1.id)
ArticleUser.create(article_id: @article6.id, user_id: @user2.id)
ArticleUser.create(article_id: @article7.id, user_id: @user1.id)
ArticleUser.create(article_id: @article8.id, user_id: @user2.id)
