...
Operator.create(value: 0, name: "Contains")
Operator.create(value: 1, name: "Does not contain")
Operator.create(value: 2, name: "Begins with")
Operator.create(value: 3, name: "End with")
Operator.create(value: 4, name: "Is equal to")
Operator.create(value: 5, name: "Is less than")
Operator.create(value: 6, name: "Is less than or equal")
Operator.create(value: 7, name: "Is more than")
Operator.create(value: 8, name: "Is more than or equal")

JoinCondition.create(value: 0, name: "OR")
JoinCondition.create(value: 1, name: "AND")
JoinCondition.create(value: 2, name: "AND NOT")
JoinCondition.create(value: 3, name: "OR NOT")
